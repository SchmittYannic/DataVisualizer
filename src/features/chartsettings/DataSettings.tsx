...
const DataSettings = ({
    ...
    const setSettingsAndRender = (newRef: SettingsType) => {
    ...
    const handleXCatColumnChange = (input: string) => {
    ...
    const handleXNumColumnChange = (input: string) => {
        const newRef = { ...settingsRef.current };
    ...
    const handleXDateColumnChange = (input: string) => {
        const newRef = { ...settingsRef.current };
    ...
    const handleYNumColumnsChange = (input: string) => {
        const newRef = { ...settingsRef.current };
    ...
    const handleZCatGroupingChange = (input: string) => {
        const newRef = { ...settingsRef.current };
