import { useState, useRef, useEffect, useId, PropsWithChildren, KeyboardEvent, ChangeEvent } from "react";
import { AnimatePresence, motion } from "framer-motion";
import { MdKeyboardArrowDown } from "react-icons/md";

import "./Dropdown.css";

type DropdownType = PropsWithChildren<{
    OptionsList: any[],
    selectedOption: any,
...
const Dropdown = ({
    ...
    const optionContainer = useRef<HTMLButtonElement>(null);
    ...
    const handleOnOptionClicked = (input: string) => {
                ...
                <div>
                    {
                        ...
                        ?   <label 
                                onClick={() => {
                                    const element = document.getElementById(comboboxId)
                                    if (!element) return
                                    element.focus();
                                }}
                            >
